...
clear
msg="
  _____     _______  _     __   _  ________  ______  __
  \_   \___/__    / / \   |  \ | ||__    __||   __ ||  |
   / /\/ _ \ / /\/ / _ \  |   \| |   |  |   |   ___||  |
/\/ /_| (_) / /   / ___ \ | |\   |   |  |   |  |___ |  |__
\____/ \___/_/   /_/   \_\|_| \__|   |__|   |______||_____|Ingenieria.com                              
"
...
sudo git clone https://github.com/Antelinge/proyecto_iot_services.git
sudo mv proyecto_iot_services services
...
sudo git clone https://github.com/Antelinge/proyecto_iot_app.git
sudo mv proyecto_iot_app  app
